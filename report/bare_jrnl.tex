...
\title{Inferring Trascription Factors from Gene Expression Data}
%
%
...
\author{Nathan Wilkinson% <-this % stops a space
...
% The paper headers
\markboth{Modeling Biological Networks}%
{Shell \MakeLowercase{\textit{et al.}}: Inferring Trascription Factors from Gene Expression Data}
...
\includegraphics[scale=.41]{all_image.png}
...
\includegraphics[scale=.41]{axl_image.png}
...
\includegraphics[scale=.65]{gene_hist.png}
...
I am very grateful to Professor Myers for teaching the Modeling Biological Networks course and for his assistance and feedback during this project. I also acknowledge the help of the CMap team and their very helpful email collaboration.
